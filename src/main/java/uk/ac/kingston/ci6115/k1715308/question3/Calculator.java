...
public class Calculator {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        SciCalcList varianceFromList = (list) -> list.stream().map(num -> num - getSciCalcListResult(list, meanFromList)).map(num -> num*num).mapToDouble(num -> num).average().orElse(0.0);
